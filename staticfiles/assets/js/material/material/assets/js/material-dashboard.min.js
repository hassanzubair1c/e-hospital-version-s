...
$(document).ready(function () {
    ...
    }, showNotification1: function (e, a) {
        console.log('messaaaaaa')
        type = ["info"], color = Math.floor(6 * Math.random() + 1), $.notify({
            icon: "add_alert",

            message: "Welcome to <b>Material Dashboard daaaaaaaa</b> - a beautiful admin panel for every web kashif."
        }, {type: type[color], timer: 3e3, placement: {from: top, align: right}})
